...
def siapa():
	...
	if nama =="":
		print"\033[1;96m[!] \033[1;91mIsi yang benar Anjinx"
		time.sleep(1)
		siapa()
	else:
		os.system('clear')
...
def loginSC():
	...
	if username =="admin" and password =="admin":
		...
		print"\033[1;96m[!] \033[1;91mLogin Gagal XXX!!!!"
		time.sleep(1)
                LoginSC()
